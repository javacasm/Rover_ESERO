...
```
![](./images/programa_rover_esero.png)
...
```
![](./images/programa_mando_ESERO.png)
...
[Ejemplo inicial de control de rover](https://github.com/javacasm/RoboticaIII-ubeda/blob/main/4.Proyectos.md#proyecto-rover-marciano)

[Mando avanzado con LCD](https://github.com/javacasm/RoboticaIII-ubeda/blob/main/sesion2_kit_avanzado.md)
